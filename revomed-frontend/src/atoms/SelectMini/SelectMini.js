...
let SelectMini = (props) => {
  ...
  */
  ...
  return (
    <label ref={wrapperRef} className="SelectMini w-100">
      ...
      {selectIsOpen ?
      ReactDOM.createPortal(<div className="ReactSelectMiniPortal"><ul style={positionStyles} className="select-list">
      	{props.variants.map((item, key) => 
