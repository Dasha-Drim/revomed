...
let WriteReview = (props) => {
	...
	useEffect(() => {
		...
		document.cookie = "linkReview=;max-age=0";
	     	...
	     	<div className="container py-sm-7">
	     		...
	     		<div className="row justify-content-center">
	     			<form className="review-form col-8 col-md-6 px-5 px-sm-7 pt-7 pb-7 py-md-7" onSubmit={addReviewFormHandler} ref={addReviewForm} noValidate>
	     				...
	     				<span className="review-form__about-item d-block pt-3 pb-2">Врач — {consultationData.doctorName}</span>
	     				<span className="review-form__about-item d-block">Стоимость — {consultationData.price}₽</span>
		     			<div className="add-mark d-inline-block mt-6 text-center">
		     				<span className="question-label d-block pt-3">Оцените сеанс</span>
			     			<div className="d-flex align-items-center pb-4 pt-3 px-5">
								<img src={iconStar[0]} className="mr-2" alt="" value="1" onClick={() => {fill(1)}}/>
								<img src={iconStar[1]} className="mr-2" alt="" value="2" onClick={() => {fill(2)}}/>
								<img src={iconStar[2]} className="mr-2" alt="" value="3" onClick={() => {fill(3)}}/>
								<img src={iconStar[3]} className="mr-2" alt="" value="4" onClick={() => {fill(4)}}/>
								<img src={iconStar[4]} alt="" value="5" onClick={() => {fill(5)}}/>
							</div> 
						</div>
						<div className="mt-5">
