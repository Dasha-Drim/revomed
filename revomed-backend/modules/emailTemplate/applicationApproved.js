          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                ...
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Добро пожаловать в REVOMED. Ваша заявка проверена модератором и вы можете начать использовать сервис REVOMED.</p>
                  </td>
                </tr>
                <tr>
