...
let template = (name, date, timezone) => {
  let mail = `
    <!DOCTYPE html>
    <html lang="ru">
    <head>
          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                ...
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Пациент забронировал онлайн-консультацию с вами. Время приёма: <span style="font-weight: 500;">` + date + `</span>. Часовой пояс пациента: <span style="font-weight: 500;">` + timezone + `</span>. Вы можете отслеживать всю информацию в личном кабинете</p>
                  </td>
                </tr>
              </tbody>
            </table>
