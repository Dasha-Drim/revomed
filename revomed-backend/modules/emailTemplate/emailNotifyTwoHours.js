          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                ...
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Ваша консультация начнется через <span style="font-weight: 500;">2 часа</span>. Время приёма: <span style="font-weight: 500;">` + date + `</span>. Часовой пояс пациента: <span style="font-weight: 500;">` + timezone + `</span>. Вы можете отслеживать всю информацию в личном кабинете</p>
                  </td>
                </tr>
              </tbody>
            </table>
