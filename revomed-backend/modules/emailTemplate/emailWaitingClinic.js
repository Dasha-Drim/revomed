          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Пациенты ожидают появления свободных слотов для записей. Пожалуйста выставите расписание для врача ` + nameDoctor + ` или попросите его сделать это в Личном кабинете. Желательно добавить минимум 3 свободных записи, чтобы пациент смог найти удобное время время.</p>
                  </td>
                </tr>
                <tr>
