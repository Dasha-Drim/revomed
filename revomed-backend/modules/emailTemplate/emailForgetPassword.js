          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                ...
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Для восстанновления пароля нажмите на кнопку, или перейдите по ссылке: <a href="` + link + `" target="_blank">`+link+`</a></p>
                  </td>
                </tr>
                <tr>
                  <td><a href="` + link + `" style="color: #ffffff; padding: .75em 1.5em; display: inline-block; background-color: #6D71F9; border-radius: 50px; text-decoration: none; margin-bottom: 3.5em">Восстановить пароль</a></td>
                </tr>
                <tr>
