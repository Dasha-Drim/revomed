          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                ...
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Вы зарегестрировались на платформе REVOMED. Данные для входа:<br>Логин: `+login+`<br>Пароль: `+password+`<br>Доступ в личный кабинет будет открыт после одобрения заявки модератором</p>
                  </td>
                </tr>
                <tr>
