          ...
          <td>
            ...
            <table style="padding: 3em;">
              <tbody>
                <tr>
                  <td>
                    <p style="color: #9B9BAB; font-weight: 300; margin: 2em 0;">Пациенты ожидают появления свободных записей. Выставите расписание в личном кабинете. Будет правильным, если Вы сможете  добавить несколько слотов  для записи пациентов на удобное время.</p>
                  </td>
                </tr>
                <tr>
